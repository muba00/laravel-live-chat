...
export type ConversationsAction =
  ...
  | { type: 'CONVERSATIONS_LOADED'; payload: { conversations: Conversation[]; page: number; hasMore: boolean } }
  ...
  | { type: 'UPDATE_LAST_MESSAGE'; payload: { conversationId: number; message: Message } }
...
export type MessagesAction =
  ...
  | { type: 'MESSAGES_LOADED'; payload: { conversationId: number; messages: Message[]; page: number; hasMore: boolean } }
  | { type: 'MESSAGES_ERROR'; payload: ApiError }
  | { type: 'MESSAGE_ADDED'; payload: Message }
  | { type: 'MESSAGE_UPDATED'; payload: Message }
  | { type: 'MESSAGE_DELETED'; payload: { conversationId: number; messageId: number } }
  ...
  | { type: 'MESSAGE_READ'; payload: { conversationId: number; messageId: number; readAt: string } }
  | { type: 'MESSAGES_RESET' };
